          ...
          <section className="rounded-[34px] border border-white/70 bg-white/78 p-6 shadow-2xl shadow-[#6d5dfc]/12 backdrop-blur-3xl">
            {loading ? (
              ...
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-lg font-black text-[#18181b]">Plan preview</h2>
              </div>
              <p className="mt-1 text-sm font-semibold leading-6 text-[#636366]">
                The plan comparison lives here now, away from the main calendar settings.
              </p>
              <div className="mt-4 grid gap-3 sm:grid-cols-2">
                <PlanPreviewCard title="Free" label={isPremium ? "Available" : "Current"}>
                  One shared calendar, personal tasks, reminders, alerts, and the core calendar workspace.
                </PlanPreviewCard>
                <PlanPreviewCard title="Premium" label={isPremium ? "Current" : "Preview"} highlighted>
                  More shared calendars, richer statistics, advanced planning helpers, and future power-user features.
                </PlanPreviewCard>
              </div>
            </div>
