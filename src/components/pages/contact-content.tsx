    ...
    >
      <InfoCard title="Message">
        <form onSubmit={submit} className="space-y-3">
          ...
          <textarea name="message" className="min-h-32 w-full resize-none rounded-2xl bg-[#f2f2f7] px-4 py-3 text-sm font-semibold outline-none" placeholder="What should we know?" required />
