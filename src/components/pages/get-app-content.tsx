  ...
  return (
    ...
    >
      <InfoCard title="iPhone and iPad">
        Open Arcgenda in Safari, tap Share, choose Add to Home Screen, then open it from your home screen. Notifications require iOS support, install-to-home-screen, permission, and a push service.
      </InfoCard>
